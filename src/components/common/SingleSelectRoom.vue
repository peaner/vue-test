<template>
  <div>
    <a @click="value4 = true" v-on:click="changeClassRoom" class="classroom-text-warp change-classroom-wrap">点击更换其他教室</a>
    <Drawer
      title="更换互动教室"
      v-model="value4"
      width="50"
      ...
      <div slot="header" class="clear">
        <Button class="select-room-submit-button" type="primary" shape="circle" @click="value4 = false" v-on:click="submitClassRoom">确认(6/6)</Button>
      </div>
